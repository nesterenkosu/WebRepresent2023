		...
		<script>
			$(function(){
				$("#user_country").change(function(){
					...
					//Подгрузка списка городов страны через AJAX-запрос
					$.get("http://demosite.biz/ajaxserver.php?country_id="+country_id,function(data){
						$("#user_city").html(data);						
					});
